...
\begin{figure}[htpb]
\centering 
\includegraphics[width=.7\textwidth]{./Figuras/diagBloques_borrador.png}
\caption{Diagrama en bloques del sistema -BORRADOR-}
\label{fig:diagBloques_borrador}
\end{figure}

\vspace{25px}

El circuito integrado AD5933 (Analog Devices, USA) tiene en sí mismo implementadas las soluciones necesarias al análisis espectróscopico de impedancia, en la Figura \ref{fig:ad5933} se observa su diagrama en bloques interno. El sistema basado en este integrado es una de las tareas de este proyecto.

\vspace{25px}

\begin{figure}[htpb]
\centering 
\includegraphics[width=.7\textwidth]{./Figuras/ad5933.png}
\caption{Diagrama en bloques del AD5933 -BORRADOR(agrandar tamaño de la tipografía)}
\label{fig:ad5933}
\end{figure}
...
Auspiciante   & \clientename      &\empclientename	& Secretario de Ciencia y Tecnología \\ \hline
Cliente       & \clientename      &\empclientename	& Secretario de Ciencia y Tecnología \\ \hline
...
\textbf{En la última columna de la tabla no funciona el comando newline }

\begin{itemize}
\item Auspiciante: está condicionado por la situación presupuestaria de la Universidad a causa de la actual Pandemia que condiciona la economía Nacional. La rendición de gastos se rige por la Ordenanda 5 del Consejo Superior de la \empclientename. Se cuenta con él y el trabajo de la directora de Ciencia y Tecnología y encargo de la Unidad de Vinculación Tecnológica.
\item Cliente: La rendición final del proyecto será evaluada sólo por el informe final que se debe presentar y la consecuente rendición de gastos.
